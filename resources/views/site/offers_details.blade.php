        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb official ">
                    ...
                    <li class="breadcrumb-item"><a href="offers.html">الحملات والعروض</a></li>
...
{{--                </p>--}}
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="about-us">
                            <a href="{{url(Storage::url($offers->img->url_video ?? ''))}}" data-fancybox>
                                <div class="video">
                                    <figure class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.4s">
                                        <img src="{{url(Storage::url($offers->img->url_image ?? ''))}}" class="img-fluid">
                                        <div class="play">
                    ...
                    <div class="d-flex align-items-center wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">
                        <svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 33 33">
                            <g id="Group_52906" data-name="Group 52906" transform="translate(-1191.086 -530)">
                                <rect id="Rectangle_12" data-name="Rectangle 12" width="32" height="32" rx="16"
                                      transform="translate(1191.586 530.5)" fill="#f3f3f3" stroke="#ebeaee"
                                      stroke-width="1" />
                                <g id="Calendar" transform="translate(1200.386 538.5)">
    ...
    <div class="modal custom-modal fade bd-example-modal-lg" tabindex="-1" role="dialog"
...
@section('script')
    ...
    <script>
        function store() {
            ...
            axios.post('/al-madina/subscribe', formData, {
                headers: {
                ...
                if(error.response.data.message.code) {
                    $('.code').text(error.response.data.message.code[0]);
                }
