                        ...
                        <form class="form">
                            <div class="form-group mb-10">
                                <input class="form-control form-control-solid h-auto py-4 px-8" type="text"
                                       placeholder="Code" id="code" name="code" autocomplete="off" />
                            </div>
                            <div class="form-group d-flex flex-wrap flex-center mt-10">
                                <button type="button" onclick="sendVerificationSms()"
                                        class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-2">Request</button>
                                <button  type="button"  onclick="cancel()" id="kt_login_forgot_cancel"
...
{{--					</div>--}}
	...
	<script>
		function sendVerificationSms() {
			axios.post('/al-madina/otp/verify',{
        ...
        function cancel() {
            axios.get('/al-madina/otp/cancel',{
            }).then(function (response) {
                // handle success
                console.log(response);
                toastr.success(response.data.message);
