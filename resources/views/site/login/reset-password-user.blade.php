...
<head>
	{{-- <base href="../../../../"> --}}
	<meta charset="utf-8" />
	<title> Reset Password | Guide</title>
					...
					<div class="login-signin">
						<div class="mb-20">
							...
							<div class="form-group mb-5" hidden>
								<input class="form-control h-auto form-control-solid py-4 px-8" value="{{$email}}" type="text"
							...
							<button type="button" class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4"
								onclick="resetPasswordUser()">Reset Password</button>
						</form>
					</div>
