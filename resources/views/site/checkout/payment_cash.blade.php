    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol  class="breadcrumb official ">
                ...
                <li class="breadcrumb-item active" aria-current="page">Payment Cash</li>
            </ol>
        </nav>
    </div>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 order-md-1">
                ...
                <form action="{{route('site.cash.order')}}"  method="post" id="payment-form">
                    @csrf
                    <div class="form-group">
                        <label for="card-element">
                            <img src="{{ asset('site/images/cash.png') }}">
