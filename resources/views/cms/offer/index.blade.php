...
@section('page-name','All Offers')
@section('main-page','Content Management')
@section('sub-page','Offer')
@section('page-name-small','All Offers')
...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            ...
            <span class="text-muted mt-3 font-weight-bold font-size-sm">Manage Offers</span>
        </h3>

        <div class="card-toolbar">
            <a href="{{route('offers.create')}}" class="btn btn-info font-weight-bolder font-size-sm">New
                Offer</a>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <img class="img-circle img-bordered-sm" width="65" height="65"
                                 src="{{url(Storage::url($offer->img->url_image ?? ''))}}"  alt="User Image">
                           </td>
                        <td>{{$offer->name ?? ''}}</td>
