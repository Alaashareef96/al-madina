...
@section('page-name','Delivered Order')
@section('main-page','Content Management')
@section('sub-page','Orders')
@section('page-name-small','Delivered Order')
...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">Delivered Order</span>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$order->payment_method   ?? ''}}</td>
                            <td>
                                <span class="label label-lg label-light-success label-inline">{{$order->status}}</span>
