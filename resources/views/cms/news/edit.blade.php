                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group">
                                ...
                                <img id="previewImg" src="{{url(Storage::url($news->img->url_image))}}" width="100px" height="100px" alt="Placeholder">
                                <p>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group">
                                ...
                                <video id="vid" src="{{url(Storage::url($news->img->url_video))}}" width="200" height="150" controls></video>
                        ...
                        <div class="form-group row mt-4">
                            ...
                            <div class="col-6">
                                <input name="name[ar]" type="text" class="form-control" id="name" value="{{$news->getTranslation('name', 'ar')}}" placeholder="Please enter your name" />
...
{{--                            </div>--}}
                        ...
                        <div class="form-group row mt-4">
                            ...
                            <div class="col-6">
                                <input name="name[en]" type="text" class="form-control" id="name_en" value="{{$news->getTranslation('name', 'en')}}" placeholder="Enter english name" />
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="details[ar]" id="details" rows="3"  placeholder="Enter ...">{{$news->getTranslation('details', 'ar')}}</textarea>
                        </div>


                        <div class="form-group">
                            <label>Details (En):</label>
                            <textarea class="form-control" name="details[en]" id="details_en" rows="3" placeholder="Enter ...">{{$news->getTranslation('details', 'en')}}</textarea>
                        </div>
                        <div class="separator separator-dashed my-10"></div>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="col-9">
                            <button type="button" onclick="update('{{$news->id}}')" class="btn btn-primary mr-2">Submit</button>
...
<script>
     function update(id){
        ...
        axios.post('/cms/admin/news/'+id, formData).then(function (response) {
