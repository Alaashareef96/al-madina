...
@section('page-name','All News')
@section('main-page','Content Management')
@section('sub-page','News')
@section('page-name-small','All News')
...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">News</span>
            <span class="text-muted mt-3 font-weight-bold font-size-sm">Manage News</span>
        </h3>
                    ...
                    <tr>
                        ...
                        <td>
                            <img class="img-circle img-bordered-sm" width="65" height="65"
                                 src="{{url(Storage::url($new->img->url_image ?? ''))}}"  alt="User Image">
                           </td>
                        <td>{{$new->name ?? ''}}</td>
                        ...
                        <td class="pr-0 text-right">
                            ...
                            <a href="#" onclick="confirmDestroy('{{$new->id}}',this)"
