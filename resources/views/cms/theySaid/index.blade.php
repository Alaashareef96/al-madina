...
@section('page-name','All TheySaid')
@section('main-page','Content Management')
@section('sub-page','TheySaid')
@section('page-name-small','All TheySaid')
...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        ...
        <div class="card-toolbar">
            <a href="{{route('they-said.create')}}" class="btn btn-info font-weight-bolder font-size-sm">New
                Team</a>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            src="{{url(Storage::url($said->image->url_image ?? ''))}}"  alt="User Image">
                           </td>
                        <td>{{$said->name ?? ''}}</td>
                        <td>{{$said->category ?? ''}}</td>
                        <td>{{$said->details ?? ''}}</td>
                        <td>{{$said->created_at->diffForHumans()}}</td>

                        <td class="pr-0 text-right">
                            <a href="{{route('they-said.edit',$said->id)}}"
                            ...
                            <a href="#" onclick="confirmDestroy('{{$said->id}}',this)"
...
<script>
    ...
    function destroy(id, reference) {
        //JS - Axios
        axios.delete('/cms/admin/they-said/'+id)
