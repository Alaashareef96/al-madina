                ...
                <form id="create-form">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mt-4">
                            ...
                            <div class="col-6">
                                <input name="name[ar]" type="text" class="form-control" id="name" value="{{$category->getTranslation('name', 'ar')}}" placeholder="Please enter your name" />
                        ...
                        <div class="form-group row mt-4">
                            ...
                            <div class="col-6">
                                <input name="name[en]" type="text" class="form-control" id="name_en" value="{{$category->getTranslation('name', 'en')}}" placeholder="Enter english name" />
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-9">
                                <button type="button" onclick="update('{{$category->id}}')" class="btn btn-primary mr-2">Submit</button>
