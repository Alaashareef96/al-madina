...
@section('page-name','Edit Jobs')
@section('main-page','Content Management')
@section('sub-page','Jobs')
@section('page-name-small','Edit Jobs')
                ...
                <form id="create-form">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mt-4">
                            ...
                            <div class="col-6">
                                <input name="name[ar]" type="text" class="form-control" id="name" value="{{$job->getTranslation('name', 'ar')}}" placeholder="Please enter your name" />
                        ...
                        <div class="form-group row mt-4">
                            ...
                            <div class="col-6">
                                <input name="name[en]" type="text" class="form-control" id="name_en" value="{{$job->getTranslation('name', 'en')}}" placeholder="Enter english name" />
                            ...
                            <div class="col-6">
                                <div class="tagify-item">
                                    <select class="js-example-basic-single" name="terms[ar][]" multiple>
                                        @foreach ($job->getTranslation('terms', 'ar') as $term)
                            ...
                            <div class="col-6">
                                <div class="tagify-item">
                                    <select class="js-example-basic-single_2" name="terms[en][]" multiple>
                                        @foreach ($job->getTranslation('terms', 'en') as $term)
                                            <option value="{{$term}}" selected>{{$term}}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="form-group row mt-4">
                            ...
                            <div class="col-3">
                                <input name="start_date" type="date" class="form-control" id="example-date-input" value="{{$job->start_date}}" placeholder="Enter expiry_date" />
                        ...
                        <div class="form-group row mt-4">
                            ...
                            <div class="col-3">
                                <input name="expiry_date" type="date" class="form-control" id="example-date-input" value="{{$job->expiry_date}}" placeholder="Enter expiry_date" />
                                <span class="form-text text-muted">Please enter expiry_date</span>
                            </div>
                        </div>
                        <div class="separator separator-dashed my-10"></div>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="col-9">
                            <button type="button" onclick="update('{{$job->id}}')" class="btn btn-primary mr-2">Submit</button>
...
<script src="{{asset('cms/assets/js/select2.js')}}"></script>
    ...
    <script>
     function update(id){
        ...
        axios.post('/cms/admin/jobs/'+id, formData).then(function (response) {
            // handle success
