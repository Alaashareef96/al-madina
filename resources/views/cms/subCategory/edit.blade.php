                ...
                <form id="create-form">
                    ...
                    <div class="card-body">
                                ...
                                <div class="dropdown bootstrap-select form-control dropup">
                                    <select class="form-control selectpicker" data-size="7" name="category_id" id="category_id"
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{$category->id}}" @if($alaas->id == $category->id) selected
                        ...
                        <div class="form-group row mt-4">
                            ...
                            <div class="col-6">
                                <input name="name[ar]" type="text" class="form-control" id="name" value="{{$subcategory->getTranslation('name', 'ar')}}" placeholder="Please enter your name" />
                        ...
                        <div class="form-group row mt-4">
                            ...
                            <div class="col-6">
                                <input name="name[en]" type="text" class="form-control" id="name_en" value="{{$subcategory->getTranslation('name', 'en')}}" placeholder="Enter english name" />
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-9">
                                <button type="button" onclick="update('{{$subcategory->id}}')" class="btn btn-primary mr-2">Submit</button>
...
@section('scripts')
    <script>
        function update(id){
            ...
            axios.post('/cms/admin/sub-categories/'+id, formData).then(function (response) {
                // handle success
