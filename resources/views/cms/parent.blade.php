...
<html dir="{{ app()->getLocale() == 'en' ?  'ltr' : 'rtl' }}" lang="en">
...
{{--        var channel = pusher.subscribe('private-App.Models.Admin.{{ Auth::id() }}');--}}
{{--        channel.bind('Illuminate\\Notifications\\Events\\BroadcastNotificationCreated', function(data) {--}}
{{--            alert(data.data['customer_name']);--}}
{{--        });--}}
{{--    </script>--}}
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{route('all-reports')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
...
{{--							</li>--}}
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-text">TheySaid</span>
                                    <i class="menu-arrow"></i>
                                </a>
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{route('they-said.create')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">Create</span>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{route('they-said.index')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">Index</span>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-text">SuccessPartners</span>
                                    <i class="menu-arrow"></i>
                                </a>
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{route('success-partners.create')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">Create</span>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{route('all-orders')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
...
{{--                                        <li class="menu-item" aria-haspopup="true">--}}
{{--                                            <a href="{{route('processing-orders')}}" class="menu-link">--}}
{{--                                                <i class="menu-bullet menu-bullet-dot">--}}
{{--                                                    <span></span>--}}
{{--                                                </i>--}}
...
{{--                                        <li class="menu-item" aria-haspopup="true">--}}
{{--                                            <a href="{{route('picked-orders')}}" class="menu-link">--}}
{{--                                                <i class="menu-bullet menu-bullet-dot">--}}
{{--                                                    <span></span>--}}
{{--                                                </i>--}}
{{--                                                <span class="menu-text">Picked</span>--}}
{{--                                            </a>--}}
{{--                                        </li>--}}
...
{{--                                                    <span></span>--}}
{{--                                                </i>--}}
{{--                                                <span class="menu-text">Shipped</span>--}}
{{--                                            </a>--}}
{{--                                        </li>--}}
{{--                                        <li class="menu-item" aria-haspopup="true">--}}
...
{{--                                        </li>--}}
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{route('return.request')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{route('return.all.request')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">Return All Request</span>
                                            </a>
                                        </li>
...
{{--                                        </li>--}}
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
									<span class="svg-icon menu-icon">
                                        ...
                                        <!--end::Svg Icon--></span>
                                    <span class="menu-text">JobsRequest</span>
                                    <i class="menu-arrow"></i>
                                </a>
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{route('show-jobsRequest')}}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">Index</span>
							...
							<span class="svg-icon menu-icon">
                                ...
                                <!--end::Svg Icon-->
                                    ...
                                    <span class="menu-text">{{__('cms.edit_password')}}</span>
                                </a>
                            </li>
							<li class="menu-item" aria-haspopup="true">
					...
					<div class="container-fluid d-flex align-items-stretch justify-content-between">
						...
						<div class="topbar">
							...
							<div class="dropdown">
								<!--begin::Toggle-->
								 <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                     <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1 pulse pulse-primary"id="newNotifications" >
												<span class="svg-icon svg-icon-primary svg-icon-2x" >{{count(Auth::user()->unreadnotifications)}}<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														<rect x="0" y="0" width="24" height="24"/>
							...
							<div class="tab-content">
								<!--begin::Tabpane-->
								<div class="tab-pane active show p-8" id="notificationsList"
									role="tabpanel">
									...
									<div class="d-flex flex-center pt-7">
										<a href="{{route('notifications')}}" class="btn btn-light-primary font-weight-bold text-center">See
											All</a>
									</div>
									<!--end::Action-->
								</div>
...
{{--								</div>--}}
								...
								<div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
									<div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
										...
										<img class="h-20px w-20px rounded-sm"
											src="{{asset('cms/assets/media/svg/flags/226-united-states.svg')}}"alt="" />
											@else
											<img class="h-20px w-20px rounded-sm"
											src="{{asset('cms/assets/media/svg/flags/208-palestine.svg')}}" alt="" />
											@endif
	</div>
	</div>
	<!--end::Toggle-->
	...
	<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
		...
		<ul class="navi navi-hover py-4">
			<!--begin::Item-->
			<li class="navi-item">
				<a href="{{route('dashboard.change-language','en')}}" class="navi-link">
