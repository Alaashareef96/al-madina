            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pl-0">
                            <span
                                class="label label-lg @if($permission->guard_name == 'admin') label-light-success @elseif($permission->guard_name == 'pro') label-light-warning @else label-light-primary @endif label-inline">{{ucfirst($permission->guard_name)}}</span>
                        </td>
