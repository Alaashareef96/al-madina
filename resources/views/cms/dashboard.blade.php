    ...
    <div class="col-xl-3">
        ...
        <div class="card card-custom bg-info card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <span
                    class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">${{$today}}</span>
                <span class="font-weight-bold text-white font-size-sm">Today's Sale</span>
            </div>
    ...
    <div class="col-xl-3">
        ...
        <div class="card card-custom bg-info card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <span
                    class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">${{$month}}</span>
                <span class="font-weight-bold text-white font-size-sm">Monthly Sale</span>
            </div>
    ...
    <div class="col-xl-3">
        ...
        <div class="card card-custom bg-info card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <span
                    class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">${{$year}}</span>
                <span class="font-weight-bold text-white font-size-sm">Yearly Sale</span>
            </div>
    ...
    <div class="col-xl-3">
        ...
        <div class="card card-custom bg-info card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <span
                    class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">{{$product}}</span>
    ...
    <div class="col-xl-3">
        ...
        <div class="card card-custom bgi-no-repeat card-stretch gutter-b"
            ...
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <span
                    class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{$pending}}</span>
