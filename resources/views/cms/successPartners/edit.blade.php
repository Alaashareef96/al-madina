...
@section('page-name','Edit Success-Partner')
@section('main-page','Content Management')
@section('sub-page','Success-Partners')
@section('page-name-small','Edit Success-Partner')
                ...
                <form id="create-form">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group">
                                ...
                                <img id="previewImg" src="{{url(Storage::url($successPartner->img->url_image))}}" width="100px" height="100px" alt="Placeholder">
                                <p>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-9">
                                <button type="button" onclick="update('{{$successPartner->id}}')" class="btn btn-primary mr-2">Submit</button>
...
@section('scripts')
    ...
    <script>
        function update(id){
            ...
            axios.post('/cms/admin/success-partners/'+id, formData).then(function (response) {
                // handle success
