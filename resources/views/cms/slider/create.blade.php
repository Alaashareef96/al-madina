...
@section('page-name','Create Slider')
@section('main-page','Content Management')
@section('sub-page','Slider')
@section('page-name-small','Create Slider')
                ...
                <form id="create-form">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mt-4">
                            ...
                            <div class="col-6">
                                <input name="url" type="text" class="form-control" id="url" placeholder="Please enter your url" />
...
@section('scripts')
    ...
    <script>
        function store() {
            ...
            axios.post('/cms/admin/slider', formData, {
                headers: {
