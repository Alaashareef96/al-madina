...
@section('page-name','All Coupons')
@section('main-page','Content Management')
@section('sub-page','Coupons')
@section('page-name-small','All Coupons')
...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            ...
            <span class="text-muted mt-3 font-weight-bold font-size-sm">Manage Coupons</span>
        </h3>
            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$coupon->qty ?? ''}}</td>
                        <td>{{ Carbon\Carbon::parse($coupon->date)->format('D, d F Y') }}</td>
                            <td><span
                                    class="badge @if($coupon->status) bg-success @else bg-danger @endif">{{$coupon->visibility}}</span>
                            </td>
                        ...
                        <td class="pr-0 text-right">
                            ...
                            <a href="#" onclick="confirmDestroy('{{$coupon->id}}',this)"
